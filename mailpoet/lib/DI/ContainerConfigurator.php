...
class ContainerConfigurator implements IContainerConfigurator {
  ...
  public function configure(ContainerBuilder $container) {
    ...
    $container->autowire(\MailPoet\AdminPages\Pages\NewsletterEditorV2::class)->setPublic(true);
    ...
    // Email Editor
    $container->autowire(\MailPoet\EmailEditor\Editor::class)->setPublic(true);
    // Features
    ...
    $container->autowire(\MailPoet\Newsletter\GutenbergFormatMapper::class)->setPublic(true);

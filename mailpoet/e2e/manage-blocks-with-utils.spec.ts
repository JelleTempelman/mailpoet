...
test.skip('can manage blocks inside the new email editor', async ({ page, editor }) => {
	...
	await page.goto('https://veljko.qawp.net/wp-admin/admin.php?page=mailpoet-newsletters#/new');
